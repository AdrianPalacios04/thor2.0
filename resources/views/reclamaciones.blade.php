                ...
                <form action="{{url('reclamaciones')}}" method="POST">
                    ...
                    <div class="form-group">
                       ...
                       <input v-model="tipo_documento" type="text" name="dni" placeholder="DNI"   readonly>
                        ...
                        <input v-model="cel" type="text" name="cel" placeholder="{{$user->id_pais}}" readonly >
                        </div>
                        ...
                        <input v-model="domicilio" type="text" id="" class="dir" name="direccion" placeholder="" value="" >
                   		...
                   		<div class="lados">
                   			...
                   			<div class="lado_der">
		                        ...
		                        <textarea name="pedido" class="pedido" id="pedidos" cols="30" rows="10" value={{old('pedido')}}></textarea>
		                        </div>
                   		...
                   		<div class="lado">
		                        ...
		                        <textarea name="detalle_reclamo" id="detalles
                            " class="detalle" cols="30" rows="10" value={{old('detalle_reclamo')}}></textarea>
		                        </div>
                   		</div>
                   		</div>
                       <div class="form-group"> 
